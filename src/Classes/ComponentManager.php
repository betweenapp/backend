...
namespace Betweenapp\Backend\Classes;
...
class ComponentManager
{
    ...
    public function registerFormComponent($alias, $className)
    {
        ...
        if(! array_key_exists($alias, $this->formComponents)) {
            ...
            throw new DuplicatedFormAliasRegistrationException('Duplicated FormComponent component alias are not allowed');
        }
    ...
    public function makeFormComponent($alias, $config = [])
    {
        if (array_key_exists($alias, $this->formComponents)) {
            ...
            throw new FormComponentNotFoundException('FormComponent Component not found');
        }
    }
